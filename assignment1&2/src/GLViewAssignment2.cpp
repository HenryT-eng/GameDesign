...
GLViewAssignment2* GLViewAssignment2::New( const std::vector< std::string >& args )
{
   GLViewAssignment2* glv = new GLViewAssignment2( args );
...
GLViewAssignment2::GLViewAssignment2( const std::vector< std::string >& args ) : GLView( args )
{
   //Initialize any member variables that need to be used inside of LoadMap() here.
   //Note: At this point, the Managers are not yet initialized. The Engine initialization
   //occurs immediately after this method returns (see GLViewAssignment2::New() for
   ...
   //GLViewAssignment2::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewAssignment2::onCreate()
{
   //GLViewAssignment2::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewAssignment2::~GLViewAssignment2()
{
   //Implicitly calls GLView::~GLView()
}


void GLViewAssignment2::updateWorld()
{
...
void GLViewAssignment2::onResizeWindow( GLsizei width, GLsizei height )
{
   GLView::onResizeWindow( width, height ); //call parent's resize method.
}


void GLViewAssignment2::onMouseDown( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseDown( e );
}


void GLViewAssignment2::onMouseUp( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseUp( e );
}


void GLViewAssignment2::onMouseMove( const SDL_MouseMotionEvent& e )
{
   GLView::onMouseMove( e );
}


void GLViewAssignment2::onKeyDown( const SDL_KeyboardEvent& key )
{
...
void GLViewAssignment2::onKeyUp( const SDL_KeyboardEvent& key )
{
   GLView::onKeyUp( key );
}


void Aftr::GLViewAssignment2::loadMap()
{
   ...
   //std::string grass2(ManagerEnvironmentConfiguration::getSMM() + "/models/grass2.wrl");
   
   //SkyBox Textures readily available
   std::vector< std::string > skyBoxImageNames; //vector to store texture paths
   //skyBoxImageNames.push_back(ManagerEnvironmentConfiguration::getSMM() + "/images/skyboxes/images.jpg");
   ...
   createAssignment2WayPoints();
}



void GLViewAssignment2::createAssignment2WayPoints()
{
