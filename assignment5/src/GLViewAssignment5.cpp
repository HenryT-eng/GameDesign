...
GLViewAssignment5* GLViewAssignment5::New( const std::vector< std::string >& args )
{
   GLViewAssignment5* glv = new GLViewAssignment5( args );
...
GLViewAssignment5::GLViewAssignment5( const std::vector< std::string >& args ) : GLView( args )
{
   //Initialize any member variables that need to be used inside of LoadMap() here.
   //Note: At this point, the Managers are not yet initialized. The Engine initialization
   //occurs immediately after this method returns (see GLViewAssignment5::New() for
   ...
   //GLViewAssignment5::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewAssignment5::onCreate()
{
   //GLViewAssignment5::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewAssignment5::~GLViewAssignment5()
{
   //Implicitly calls GLView::~GLView()
}


void GLViewAssignment5::updateWorld()
{
...
void GLViewAssignment5::onResizeWindow( GLsizei width, GLsizei height )
{
   GLView::onResizeWindow( width, height ); //call parent's resize method.
}


void GLViewAssignment5::onMouseDown( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseDown( e );
}


void GLViewAssignment5::onMouseUp( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseUp( e );
}


void GLViewAssignment5::onMouseMove( const SDL_MouseMotionEvent& e )
{
   GLView::onMouseMove( e );
}


void GLViewAssignment5::onKeyDown( const SDL_KeyboardEvent& key )
{
...
void GLViewAssignment5::onKeyUp( const SDL_KeyboardEvent& key )
{
   GLView::onKeyUp( key );
   if (key.keysym.sym == SDLK_w)
   {
...
void Aftr::GLViewAssignment5::loadMap()
{
   ...
   //std::string Sbox(ManagerEnvironmentConfiguration::getSMM() + "/models/box.obj");
   std::string Lbox(ManagerEnvironmentConfiguration::getLMM() + "/models/box.obj");
   std::string spider(ManagerEnvironmentConfiguration::getLMM() + "/models/spider.obj");
   ...
   //{
   //    WO* wo = WO::New(Lbox, Vector(1, 1, 1), MESH_SHADING_TYPE::mstFLAT);
   //    wo->setPosition(Vector(0, 0, 1));
   //    wo->renderOrderType = RENDER_ORDER_TYPE::roOPAQUE;
   //    wo->setLabel("box");
   //    worldLst->push_back(wo);
   //}
   ...
   {
       WO* wo = WO::New(spider, Vector(1, 1, 1), MESH_SHADING_TYPE::mstFLAT);
       wo->setPosition(Vector(5, 5, 1));
       wo->renderOrderType = RENDER_ORDER_TYPE::roOPAQUE;
       wo->setLabel("spider");
       worldLst->push_back(wo);
   }
   ...
   //{
   //    WO* wo = WO::New(gem, Vector(1, 1, 1), MESH_SHADING_TYPE::mstFLAT);
   //    wo->setPosition(Vector(0, 0, 1));
   //    wo->renderOrderType = RENDER_ORDER_TYPE::roOPAQUE;
   //    wo->setLabel("gem");
   //    worldLst->push_back(wo);
   ...
   createAssignment5WayPoints();
}


void GLViewAssignment5::createAssignment5WayPoints()
{
