...
GLViewAssignment9* GLViewAssignment9::New( const std::vector< std::string >& args )
{
   GLViewAssignment9* glv = new GLViewAssignment9( args );
...
GLViewAssignment9::GLViewAssignment9( const std::vector< std::string >& args ) : GLView( args )
{
   //Initialize any member variables that need to be used inside of LoadMap() here.
   //Note: At this point, the Managers are not yet initialized. The Engine initialization
   //occurs immediately after this method returns (see GLViewAssignment9::New() for
   ...
   //GLViewAssignment9::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewAssignment9::onCreate()
{
   //GLViewAssignment9::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewAssignment9::~GLViewAssignment9()
{
   //Implicitly calls GLView::~GLView()
}


void GLViewAssignment9::updateWorld()
{
...
void GLViewAssignment9::onResizeWindow( GLsizei width, GLsizei height )
{
   GLView::onResizeWindow( width, height ); //call parent's resize method.
}


void GLViewAssignment9::onMouseDown( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseDown( e );
}


void GLViewAssignment9::onMouseUp( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseUp( e );
}


void GLViewAssignment9::onMouseMove( const SDL_MouseMotionEvent& e )
{
   GLView::onMouseMove( e );
}


void GLViewAssignment9::onKeyDown( const SDL_KeyboardEvent& key )
{
...
void GLViewAssignment9::onKeyUp( const SDL_KeyboardEvent& key )
{
   GLView::onKeyUp( key );
}


void Aftr::GLViewAssignment9::loadMap()
{
   ...
   createAssignment9WayPoints();
}


void GLViewAssignment9::createAssignment9WayPoints()
{
