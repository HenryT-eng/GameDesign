...
#include <vector>
#include <memory>
#include "GLViewAssignment4.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAssignment4 > glView( Aftr::GLViewAssignment4::New( args ) );
