...
#include <vector>
#include <memory>
#include "GLViewAssignment3.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAssignment3 > glView( Aftr::GLViewAssignment3::New( args ) );
