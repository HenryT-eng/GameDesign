...
#include <vector>
#include <memory>
#include "GLViewAssignment8.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAssignment8 > glView( Aftr::GLViewAssignment8::New( args ) );
