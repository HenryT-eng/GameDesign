...
#include <vector>
#include <memory>
#include "GLViewAssignment2.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAssignment2 > glView( Aftr::GLViewAssignment2::New( args ) );
