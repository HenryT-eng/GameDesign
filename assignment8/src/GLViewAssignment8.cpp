...
GLViewAssignment8* GLViewAssignment8::New( const std::vector< std::string >& args )
{
   GLViewAssignment8* glv = new GLViewAssignment8( args );
...
GLViewAssignment8::GLViewAssignment8( const std::vector< std::string >& args ) : GLView( args )
{
   //Initialize any member variables that need to be used inside of LoadMap() here.
   //Note: At this point, the Managers are not yet initialized. The Engine initialization
   //occurs immediately after this method returns (see GLViewAssignment8::New() for
   ...
   //GLViewAssignment8::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewAssignment8::onCreate()
{
   //GLViewAssignment8::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewAssignment8::~GLViewAssignment8()
{
   //Implicitly calls GLView::~GLView()
}


void GLViewAssignment8::updateWorld()
{
...
void GLViewAssignment8::onResizeWindow( GLsizei width, GLsizei height )
{
   GLView::onResizeWindow( width, height ); //call parent's resize method.
}


void GLViewAssignment8::onMouseDown( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseDown( e );
}


void GLViewAssignment8::onMouseUp( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseUp( e );
}


void GLViewAssignment8::onMouseMove( const SDL_MouseMotionEvent& e )
{
   GLView::onMouseMove( e );
}


void GLViewAssignment8::onKeyDown( const SDL_KeyboardEvent& key )
{
...
void GLViewAssignment8::onKeyUp( const SDL_KeyboardEvent& key )
{
   GLView::onKeyUp( key );
}


void Aftr::GLViewAssignment8::loadMap()
{
   ...
   createAssignment8WayPoints();
}


void GLViewAssignment8::createAssignment8WayPoints()
{
