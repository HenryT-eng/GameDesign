...
#include <vector>
#include <memory>
#include "GLViewAssignment5.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAssignment5 > glView( Aftr::GLViewAssignment5::New( args ) );
