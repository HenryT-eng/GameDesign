...
#include <vector>
#include <memory>
#include "GLViewAssignment9.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAssignment9 > glView( Aftr::GLViewAssignment9::New( args ) );
